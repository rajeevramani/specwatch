...
Generated: 2026-06-06T04:00:47.488Z
...
|---|---|---|---|---|---|---|---|
| `descriptions` | `no-descriptions` | description_coverage 100→26<br>doc_clarity 100→26<br>descriptive_richness 100→26 | 100% (8/8) | 100% (8/8) | **0pp** | 1.000 | no |
| `operationId` | `bad-operationids` | operationid_quality 100→22<br>tool_calling 100→65<br>distinctiveness 100→64 | 100% (8/8) | 100% (8/8) | **0pp** | 1.000 | no |
| `examples` | `no-examples` | request_examples 35→0<br>response_examples 100→0 | 100% (8/8) | 100% (8/8) | **0pp** | 1.000 | no |
| `errorSchemas` | `no-error-schemas` | error_standardization 100→0 | 100% (8/8) | 100% (8/8) | **0pp** | 1.000 | no |
| `completeness` | `thin-responses` | _(runtime-only; spec = gold)_ | 100% (8/8) | 100% (8/8) | **0pp** | 1.000 | no |

**No signal moved success on this dataset** — and this was a LIVE run (`openrouter:anthropic/claude-sonnet-4.5`): every degraded variant matched gold (full success). A real null result — for this conventional CRUD API and 8-task set, the agent was robust to every ablation. See notes for how to harden the setup to surface a gradient.
...
|---|---|---|---|---|---|---|---|---|
| `gold` | — | 93 (A) | 100% (8/8) | 24 | 0 | 0 | — | 0 |
| `no-descriptions` | descriptions | 84 (B) | 100% (8/8) | 24 | 0 | 0 | — | 0 |
| `bad-operationids` | operationId | 87 (B) | 100% (8/8) | 24 | 0 | 0 | — | 0 |
| `no-examples` | examples | 84 (B) | 100% (8/8) | 24 | 0 | 0 | — | 0 |
| `no-error-schemas` | errorSchemas | 88 (B) | 100% (8/8) | 24 | 0 | 0 | — | 0 |
| `thin-responses` | completeness _(runtime)_ | 93 (A) | 100% (8/8) | 24 | 0 | 0 | — | 0 |
| `all-bad` | descriptions, operationId, examples, errorSchemas, completeness _(runtime)_ | 63 (C) | 100% (8/8) | 24 | 0 | 0 | — | 0 |
